...
<header id="home" class="h-screen border-b-black border-b-2 bg-light-blue flex flex-col md:flex-row justify-center md:justify-between items-center px-20 mb-64">

...
var _a = process.env, DB_USER = _a.DB_USER, DB_PASSWORD = _a.DB_PASSWORD;
var express = require("express");
var app = express();
var Sequelize = require("sequelize").Sequelize;
var db = new Sequelize("postgres://".concat(DB_USER, ":").concat(DB_PASSWORD, "@192.168.0.152:5432/frt"));
try {
    db.authenticate();
...
var hashPassword = function (user, options) { return __awaiter(_this, void 0, void 0, function () {
    var hash;
...
app.post("/login", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var user, validPassword, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, User.findOne({ where: { username: req.body.username } })];
            case 1:
                user = _a.sent();
                if (!user) {
